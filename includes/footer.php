	...
	<div class="wrap" style="width: 80%;">
		<div class="footer-grids">
			...
			<div class="footer-grid address">
				<h3>Plateforme mobile </h3>
				<img src="images/appstore.png" width="75%" style="cursor: pointer;">
				<img src="images/playstore.png" width="75%" style="cursor: pointer;">
				<h3 style="margin-top: 10px; margin-bottom: 0;">Retrouvez-nous sur </h3>
